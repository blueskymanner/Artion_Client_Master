...
const cards = [
  ...
  },
  {
    ...
    title: 'Super Fast',
    description:
      'Since Artion runs on the Ethereum Network, transactions are usually confirmed within 1-2 seconds.',
    path: '/',
  },
  {
    icon: card3,
        ...
        <div className={styles.main}>
          <div className={styles.mainLeft}>
            ...
            <div className={styles.subtitle}>
              Artion is an NFT marketplace built on Ethereum. Create and trade
